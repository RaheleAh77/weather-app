let imgsArray = ["../image/cloudywhether", "../image/bridge", "../image/freedom", "../image/sunshine", "../image/beach", "../image/flower-1", "../image/flower-2"];
let randomImgIndex;

setInterval(function () {
  randomImgIndex = Math.floor(Math.random() * imgsArray.length);
  document.body.style.backgroundImage = "url(imgsArray[randomImgIndex])";
}, 3000);
